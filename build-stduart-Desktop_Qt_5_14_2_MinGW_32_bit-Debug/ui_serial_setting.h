...
public:
    ...
    void setupUi(QWidget *serial_setting)
    {
        ...
        toolBox->setGeometry(QRect(210, 30, 261, 591));
        page = new QWidget();
        ...
        sizePolicy3.setHeightForWidth(comboBox_8->sizePolicy().hasHeightForWidth());
        comboBox_8->setSizePolicy(sizePolicy3);
        ...
        gridLayout_8->addWidget(tableView, 6, 0, 1, 3);
        ...
        gridLayout_8->addWidget(pushButton_12, 5, 0, 1, 1);
        ...
        groupBox->setGeometry(QRect(60, 110, 120, 80));
    ...
    void retranslateUi(QWidget *serial_setting)
    {
        ...
        pushButton_12->setText(QCoreApplication::translate("serial_setting", "\346\270\205\347\251\272\346\211\200\346\234\211", nullptr));
        ...
        groupBox->setTitle(QCoreApplication::translate("serial_setting", "GroupBox", nullptr));
